...
digraph G {
  ...
  subgraph cluster_0 {
    ...
    dictionary [shape="rect"; label="Data\nDictionary"];  
    glossary [shape="rect"; label="Business\nGlossary"];

    sdml -> glossary [style="dashed"];
    glossary -> dictionary [style="dashed"];
    dictionary -> catalog [style="dashed"];
  }
  ...
  dictionary -> foundation [arrowhead="open"];
